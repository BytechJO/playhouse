          ...
          return (
            ...
            this.each(function () {
              var s,
                ...
                d = i(this, "marginLeft"),
                _ = i(this, "marginTop"),
                D = h + d + i(this, "marginRight") + y.width,
        ...
        for (D = "", this.maxRows = 4, x = 0; U[1] > x; x++) {
          ...
          for (
            M +=
              ...
              I +
              "'>" +
              (/all|left/.test(I) && 0 === k ? (B ? a : s) : "") +
              (/all|right/.test(I) && 0 === k ? (B ? s : a) : "") +
          ...
          for (
            M += T + "</tr></thead><tbody>",
              ...
              this.maxRows = O,
              z = this._daylightSavingAdjust(new Date(te, Z, 1 - A)),
              N = 0;
            O > N;
            N++
          ) {
              ...
              (W = m ? m.apply(t.input ? t.input[0] : null, [z]) : [!0, ""]),
                ...
                (E +=
                  ...
                  ((z.getTime() === C.getTime() &&
                    Z === t.selectedMonth &&
                    t._keyEvent) ||
                  (b.getTime() === z.getTime() && b.getTime() === C.getTime())
                    ? " " + this._dayOverClass
                    : "") +
                  (R

function initActivity(activity) {
  ...
  jQuery.each(activity.questions, function (key, values) {
    drag_drop_questions +=
      '<li class="item d-flex flex-column"><ul style="padding: 0px;">';
    if (typeof values == "string") {
      ...
      drag_drop_questions +=
        '<div class="i_container"><div class="i_row d-flex flex-column flex-wrap justify-content-center align-items-start"><div class="l_col"><img src="' +
        img_array[key] +

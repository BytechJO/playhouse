var stereo_data = {
  ...
  "playListData" : [
      {
        'audiourl': '../audios/page10/PLAYHOUSE_1_WB_UNIT_2_TRACK_03_01.mp3',
      },
      {
        'url': '',
      },
...
var fillin_data = {    
    ...
    "questions": [{
            ...
            "image": "../images/pages/activities/p10_1_a.png",
            "answer": ["my"],
        ...
        },
        {
            ...
            "audio": "../audios/under.mp3",
            "audioenable": "default", // correct (or) default
            "image": "../images/pages/activities/p10_1_b.png",
            "answer": ["your"],
            "strictcase": "no", // yes (or) no 
            "type": "text", // text (or) number
        },
        {
            ...
            "audio": "../audios/under.mp3",
            "audioenable": "default", // correct (or) default
            "image": "../images/pages/activities/p10_1_c.png",
            "answer": ["my"],
            "strictcase": "no", // yes (or) no
            "type": "text", // text (or) number
        }

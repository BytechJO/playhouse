  ...
  if (aObj != undefined && aObj != null) {
    ...
    htmlStmt += '<div class="screen_elements d-flex flex-column">';
      ...
      htmlStmt += '<div class="group_elm d-flex flex-wrap justify-content-center">';
        ...
        if(aObj.images != undefined && aObj.images != "" && aObj.img_postion == "front") {
          htmlStmt += '<div class="q_image d-flex flex-column">';
      ...
      htmlStmt += '<div class="ques">';
        ...
        if(aObj.images != undefined && aObj.images != "" && aObj.img_postion == "back") {
          htmlStmt += '<div class="q_image d-flex flex-column">';
          for(let x=0; x<aObj.images.length; x++) {
            htmlStmt += '<img src="'+aObj.images[x]+'"/>';
          }

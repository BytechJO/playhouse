var _data = {
    ...
    "header": {
       ...
       "audio": "./audios/page_38/UNIT_5_My_Friends.mp3",
       "title":{
           "text": "My Friends",
    ...
    "footer": {
        ...
        "reviewbutton" : {
            'visible'   : 'yes', // yes (or) no
            'link'      : 'Playhouse_Review_G1_U5/views/fillin_text_in_sentences.html'
        },
        "booksbutton" : {
            "workbook": {
                'icon'   : '../images/icons/book-2.png',
                'link'      : '../Playhouse_WB_G1_U5/views/match_text_vertical.html'
            },
            "studentbook": {

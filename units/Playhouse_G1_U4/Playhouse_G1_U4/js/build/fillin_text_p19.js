		...
		htmlStmt += '<div class="group_elm '+aObj.parentClassName+'">';
			...
			for (x = 0; x < numOfQuestions; x++) {
				...
				if (x == 0){
					...
					// 	htmlStmt += xx+'. </div>';
					// }
					htmlStmt += '<div class="fillin_set d-flex flex-wrap fill_0" style="justify-content: center;">';
						htmlStmt += qStr;
						...
						if(tmpObj.image != undefined && tmpObj.image != ""){
							htmlStmt += '<div class="q_img"><img src="' + tmpObj.image + '"></div>';
						}

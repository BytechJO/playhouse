var _data = {
    ...
    "header": {
       ...
       "audio": "./audios/page_32/PLAYHOUSE_1_SB_UNIT_4.mp3",
       "title":{
           "text": "My Body",
    ...
    "footer": {
        ...
        "reviewbutton" : {
            'visible'   : 'yes', // yes (or) no
            'link'      : 'Playhouse_Review_G1_U4/views/match_text_vertical.html'
        },
        "booksbutton" : {
            "workbook": {
                'icon'   : '../images/icons/book-2.png',
                'link'      : '../Playhouse_G1_U4/views/drag_drop_text_1.html'
            },
            "studentbook": {

		...
		for (x = 0; x < numOfRows; x++) {
			...
			for (y = 0; y < numInRowArray[x].length; y++) {
				...
				// if (tmpObj.singleword) {
					console.log(((aObj.questions)[currentQue - 1]).text)
					var ques = ((aObj.questions)[currentQue - 1])
					var inputboxstmt = ques.text.replace(/\[_]/g, '<input class="text_input_area" type="text" maxlength="' + ques.maxlength + '" data-type="' + ques.type + '">');; 

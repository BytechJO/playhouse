...
function buildCircleAnswerBody(aObj) {
  ...
  htmlStmt += '<div class="main-img" style="height: 500px; width: auto;">';
htmlStmt += "<img src='" + aObj.mainImg + "' style='height: 100%; width: 100%; object-fit: contain;'/>";
        htmlStmt += '</div>';
        ...
        for (var q = 0; q < numOfQuestions; q++) {
            ...
            htmlStmt += '<div class="que circleanswer_que" id="que_' + qNo + '" data-qno="' + qNo + '">';
            ...
            if (qObj.audio != '' && qObj.audio != undefined) {
                htmlStmt += '    <div class="audioIcon queAudio" data-audio="' + qObj.audio + '"></div>';
            }
            ...
            for (var o = 0; o < qObj.options.length; o++) {
                ...
                htmlStmt += '          <span class="bubble_text">' + optObj.text + '</span>';

                if (optObj.audio != '' && optObj.audio != undefined) {
                    htmlStmt += '          <div class="audioIcon optAudio" data-audio="' + optObj.audio + '"></div>';
                }

                htmlStmt += '        </div>';
                // SVG overlay for the hand-drawn circle, sized to the bubble via CSS/JS
                htmlStmt += '        <svg class="circle_svg" viewBox="0 0 220 110" preserveAspectRatio="none">';

...
function getStrArrayMy(str, pos) {
  var arr = [];
  var arrIndx = 0;
  if (str != null) {
    str = str.toString().split("/");
      ...
      if (_fileType != "" && _fileBuild != "") {
        if (_fileBuild == "yes") {
          switch (_fileType) {
            ...
            case "colourword":
              if (
                typeof colourword_data != undefined &&
                colourword_data != null
              ) {
            ...
            case "openwrite":
              if (
                ...
                buildOpenWriteBody(openwrite_data);
              }
              break;
            case "colourimg":
              if (
                typeof colourimg_data != undefined &&
                colourimg_data != null
              ) {
                buildColourImgBody(colourimg_data);
              }
              break;
          }
        } else {

...
function initiateActivityType(aActTyp, aActSubType) {
  ...
  } else if (aActTyp == "writebox") {
    theActivity = new WriteBox(quePart, writebox_data);
  } else if (aActTyp == "colourword") {
    theActivity = new ColourWord(quePart, colourword_data);
  } else if (aActTyp == "openwrite") {

function buildMcqBody(aObj) {
  ...
  if (aObj != undefined && aObj != null) {
    ...
    for (var x = 0; x < numOfQuestions; x++) {
      ...
      htmlStmt += '<div class="pick_grp w-100 d-flex flex-wrap">';
      ...
      for (var y = 0; y < options.length; y++) {
        ...
        htmlStmt += '<div class="txt_box d-flex flex-column justify-content-center align-items-center" data - type="text" >';
        htmlStmt += '<img src="'+options[y].image+'">';
      ...
      htmlStmt += '<span class="fill_text">'+tpOb.fill_text+'</span>';

var _data = {
    ...
    "header": {
       ...
       "audio": "./audios/page_88/UNIT_12-He_Works_in_an_Office.mp3",
       "title":{
           "text": "He Works in an Office",
    ...
    "footer": {
        ...
        "reviewbutton" : {
            'visible'   : 'yes', // yes (or) no
            'link'      : 'Playhouse_Review_G1_U12/views/fill_in_text_under_sentences.html'
        },
        "booksbutton" : {
            "workbook": {
                'icon'   : '../images/icons/book-2.png',
                'link'      : '../Playhouse_WB_G1/views/fillin_text.html'
            },
            "studentbook": {

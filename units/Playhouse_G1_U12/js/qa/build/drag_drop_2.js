function initActivity(activity) {
  ...
  drag_drop_questions += '<div class="images">';
  for (let i = 0; i < img_array.length; i++) {
    drag_drop_questions += '<img src="' + img_array[i] + '">';
  }
  jQuery.each(activity.questions, function (key, values) {
    drag_drop_questions +=
      '<li class="que_item d-flex flex-wrap" style=""><ul>';
  ...
  var html = "";
  html +=
    '<div class="d-flex flex-column justify-content-center" style="height:100%; margin-bottom: 20px; margin-top: 20px;">';

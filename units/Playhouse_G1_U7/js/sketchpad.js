...
if (!Array.prototype.findIndex) {
  ...
  Object.assign(Resources.prototype, {
      ...
      getImage: function getImage(url, callback, onError) {
          ...
          var img = new Image();
        //   img.crossOrigin = "cross-origin-isolated";//cross orgin fix
  ...
  function Sketchpad(config) {
      ...
      if (NSSketchpad.watermarkImageSrc) {
        ...
        //   this.watermark.crossOrigin = "cross-origin-isolated";
      }
    ...
    //   this.backgroundIFrame.allow = 'cross-origin-isolated';
  ...
  Object.assign(Sketchpad.prototype, {
      ...
      setSketchConfig: function setSketchConfig(config) {
          ...
          if (config.backgroundUrl) {
            ...
            //   this.backgroundIFrame.crossOrigin = "cross-origin-isolated";
          } else {
          ...
          if (config.backgroundImage) {
            ...
            //   this.background.crossOrigin = "cross-origin-isolated";
          } else {
              this.background.src = "";
          ...
          if (config.foregroundImage) {
            ...
            //   this.foreground.crossOrigin = "cross-origin-isolated";
          } else {
              this.foreground.src = "";

var _data = {
    ...
    "header": {
       ...
       "audio": "./audios/page_54/UNIT_7_It’s_My_Birthday!.mp3",
       "title":{
    ...
    "footer": {
        ...
        "reviewbutton" : {
            'visible'   : 'yes', // yes (or) no
            'link'      : 'Playhouse_Review_G1_U7/views/circle_word_in_sentence.html'
        },
        "booksbutton" : {
            "workbook": {
                'icon'   : '../images/icons/book-2.png',
                'link'      : '../Playhouse_G1/views/fillin_table.html'
            },
            "studentbook": {

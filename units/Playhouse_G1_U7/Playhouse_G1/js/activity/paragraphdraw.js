//  ****************************************** //
//  ParagraphDraw - Version no: 1
//  Free-write paragraph blanks + free draw canvas (blank, no background image), no validation
//  ****************************************** //
window.ParagraphDraw = function(obj, dataObj){
    ob = obj[0].getElementsByClassName("options");
    console.log('ParagraphDraw > ', $('.activity_area'));
    this.settings = {
        'activity_area' : ob[0],
...
ParagraphDraw.prototype = {
    ...
    listen:function(ob){
        ...
        // free-write paragraph blanks
        var pdInputs = e.querySelectorAll('.pd_input');
        for (var i = 0; i < pdInputs.length; i++) {
            pdInputs[i].addEventListener('input', function(){

...
function initiateActivityType(aActTyp, aActSubType) {
    ...
    }else if (aActTyp == 'readcolour') {
        theActivity = new ReadColour(quePart, readcolour_data);
    }
    else if (aActTyp == 'paragraphdraw') {
        theActivity = new ParagraphDraw(quePart, paragraphdraw_data);
    }

var _data = {
    ...
    "header": {
       ...
       "audio": "./audios/page_22/PLAYHOUSE_1_SB_UNIT_3.mp3",
       "title":{
           "text": "There’s My House!",
    ...
    "footer": {
        ...
        "reviewbutton" : {
            'visible'   : 'yes', // yes (or) no
            'link'      : 'Playhouse_Review_G1_U3/views/fillin_text_with_background.html'
        },
        "booksbutton" : {
            "workbook": {
                'icon'   : '../images/icons/book-2.png',
                'link'      : '../Playhouse_WB_G1_U3/views/match_img_horizantal.html'
            },
            "studentbook": {

function buildDrawWriteBody(aObj) {
  ...
  if (aObj != undefined && aObj != null) {
    ...
    htmlStmt +=
      '<a href=""><img src="../images/icons/back_btn.png" /></a></div>';
    htmlStmt +=
      '<div class="sub_footer_icon sub_footer_icon_right subFooterNav nextNav mx-1">';
    htmlStmt +=
      '<a href=""><img src="../images/icons/next_btn.png" /></a></div>';
    ...
    htmlStmt +=
      '<div class="audioIcon off contant audioQuestionTitle" data-audio="' +
      aObj.subTitleAudio +
      '">';
    ...
    htmlStmt +=
      '<div class="dw_draw_label">' + (aObj.drawLabel || "Draw") + "</div>";
    ...
    htmlStmt += '<div class="dw_bubble_cotainer">';
    htmlStmt += '<div class="dw_bubble_wrap">';
    htmlStmt += '<div class="dw_bubble">';
    htmlStmt += '<input class="dw_input lined_input" type="text" ';
    htmlStmt += 'placeholder="' + (aObj.bubblePlaceholderQ || "Q") + '" ';
    ...
    htmlStmt += '<div class="dw_bubble">';
    htmlStmt += '<input class="dw_input lined_input" type="text" ';
    htmlStmt += 'placeholder="' + (aObj.bubblePlaceholderA || "A") + '" ';
    htmlStmt += 'autocomplete="off" />';
    htmlStmt += "</div>";
    htmlStmt += "</div>";

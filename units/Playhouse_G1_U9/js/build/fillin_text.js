    ...
    htmlStmt += '<div class="screen_elements d-flex flex-column">';
      ...
      htmlStmt += '<div class="ques">';
        for (x = 0; x < numOfQuestions; x++) {
          ...
          if(tmpObj.images != undefined && tmpObj.images != ""){
            htmlStmt += '<div class="image_group">';
            for(let x=0; x<tmpObj.images.length; x++){
               htmlStmt += '<img class="img-'+x+'" src="'+tmpObj.images[x]+'"/>';
            }
            htmlStmt += '</div>';
          }

          if(tmpObj.image != undefined && tmpObj.image != ""){

var _data = {
    ...
    "header": {
       ...
       "audio": "./audios/page_66/UNIT_9__I_Like_Bananas!.mp3",
       "title":{
           "text": "I Like Bananas!",
    ...
    "footer": {
        ...
        "reviewbutton" : {
            'visible'   : 'yes', // yes (or) no
            'link'      : 'Playhouse_Review_G1_U9/views/fillin_text_in_sentences.html'
        },
        "booksbutton" : {
            "workbook": {
                'icon'   : '../images/icons/book-2.png',
                'link'      : '../Playhouse_G1/views/multiple_choice.html'
            },
            "studentbook": {

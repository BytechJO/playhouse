...
var fillin_data = {
  ...
  "subTitleTextLeft"      : "<span class='blue_text'>4</span> You do it.",
  "subTitleTextRight"     : "Ask a friend. Then write.",
  "subTitleIcons"         : ["../images/pages/sb-icons/conv_3_icon.png"],
  "subTitleAudio"         : "../audios/new/p85doit.mp3",
  "ontextaudioplay"       : '',
  "onimgaudioplay"        : '',
  "numbering"             : "number", // "alphabet" (or) "number"
  "numberstartfrom"       : "a",
  "image"                 : "",
  "images"                : ["../images/pages/activities/Asset7.png","../images/pages/activities/Asset8.png"],
  "options"               : [],
  "optionsAudios"         : [],
  "questions": 
  [

var snapshot_data = {
  snapshot: [
    {
      audio: [
        "../audios/page_82/pizza.mp3",
        "../audios/page_82/dough.mp3",
        "../audios/page_82/sauce.mp3",
        "../audios/page_82/sprinkle.mp3",
        "../audios/page_82/cheese.mp3",
        "../audios/page_82/add.mp3",
        "../audios/page_82/pepperoni.mp3",
        "../audios/page_82/slice.mp3",
      ],
      image: [
  ...
  slides: [
    {
      listen: {
        ...
        mainTitle_audio: "../audios/page_82/WORD_POWER.mp3",
        titleTexts: [
        ...
        titlesAudio: [
          "../audios/page_82/1_Listen_and_say.mp3",
          "../audios/page_82/PLAYHOUSE_1_SB_UNIT_1_TRACK_02_02.mp3",
        ],
        image: [
        ...
        audio: [
          ...
          "../audios/page_82/2_ship.mp3",
          "../audios/page_82/3_plane.mp3",
          "../audios/page_82/4_bike.mp3",
          "../audios/page_82/5_car.mp3",
          "../audios/page_82/6_bus.mp3",
          "../audios/page_82/7_lorry.mp3",
          "../audios/page_82/8_van.mp3",
          "../audios/page_82/9_taxi.mp3",
          "../audios/page_82/10_train.mp3",
        ],
      },
      listen2: {
        ...
        titlesAudio: ["../audios/page_82/Pg4_1.2_Adult_Lady.mp3"],
        image: [
          "../images/pages/page-1/2-img-1.png",
          "../images/pages/page-1/2-img-2.png",
        ],
        audio: [
          "../audios/page_82/Pg5_2.2_Adult Lady.mp3",
          "../audios/page_82/Pg5_2.3_Adult Lady.mp3",
        ],
      },
    },
  ],

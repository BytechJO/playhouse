...
var fillin_data = {    
    ...
    "subTitleTextRight"     : "",
    "subTitleIcons"         : [],
    "subTitleAudio"         : "../audios/new/p85write.mp3",
    "defaultAnswer"         : 1,
    "leftList"              : '',
    "image"                 :"",
    "questions": [{
        ...
        },
        {
            ...
            "answer": ["Yoshi rides a bike to the park"],
            "strictcase": "no", // yes (or) no 
            "type": "text", // text (or) number
        },
        {
            ...
            "answer": ["Max takes a bus to the farm"],
            "strictcase": "no", // yes (or) no 
            "type": "text", // text (or) number
        },
        {
          ...
          "answer": ["Lilly flies in a plane to India"],
          "strictcase": "no", // yes (or) no 
          "type": "text", // text (or) number
      },
    ]

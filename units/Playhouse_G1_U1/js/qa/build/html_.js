...
function writeHtml(activity, activity_html){
	jQuery('.activity_container').html( '<div class="activity-heading"><div class="heading_image"><img src="../images/icons/'+activity.image+'" /></div><div class="heading_text">'+activity.heading+'</div><div style="clear:both;"></div></div><div class="activity-content">'+activity_html+'</div><div class="modal fade activityResult" tabindex="-1" role="dialog" aria-hidden="true"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal">&times;</button></div><div class="modal-body"></div></div></div></div>' );
}

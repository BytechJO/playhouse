...
function validateActivity() {
	...
	if(typeof(activity_type)!='undefined'){
		...
		jQuery('.'+activity_type+'_activity input[type="text"].answer_text').each(function(k, v){
			if(_activity_json.answers[k].answer!=jQuery(this).val()){
		...
		jQuery('.'+activity_type+'_activity input[type="text"].order_text').each(function(k, v){
			if(_activity_json.answers[k].order!=jQuery(this).val()){
				jQuery('<span class="activity_result"><img src="../images/icons/cross_btn.png" /></span>').insertAfter(jQuery(this));
				err++;
			} else {
				jQuery('<span class="activity_result"><img src="../images/icons/check_btn.png" /></span>').insertAfter(jQuery(this));

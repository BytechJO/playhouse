function validateActivity() {
	...
	if(typeof(activity_type)!='undefined'){
		...
		jQuery('.'+activity_type+'_activity .group_fill_cols').each(function(col_index, col_value){
			jQuery(this).find('input[type="text"]').each(function(input_index, input_value){
				if(_activity_json.answers[col_index][input_index]!=jQuery(this).val()){

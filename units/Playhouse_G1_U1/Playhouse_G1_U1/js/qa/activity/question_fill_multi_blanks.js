...
function validateActivity() {
	...
	if(typeof(activity_type)!='undefined'){
		...
		jQuery('.'+activity_type+'_activity ul.questions_list li').each(function(question_index, question_value){



		jQuery(this).find('input[type="text"]').each(function(k, v){
			if(_activity_json.answers[question_index][k]!=jQuery(this).val()){

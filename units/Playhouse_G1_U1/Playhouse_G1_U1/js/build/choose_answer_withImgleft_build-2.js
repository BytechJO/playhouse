function buildMcqBody(aObj) {	
	...
	if(typeof aObj !=undefined && aObj !=null){		
		...
		htmlStmt +=  '</div>'
	        ...
	        if(aObj.aminActivityheading){
            htmlStmt += '<div class="audioIcon mt-50 width-fit off d-flex contant " data-audio="' + aObj.audio + '">';
            htmlStmt += aObj.aminActivityheading ? `<img src="${aObj.aminActivityheading}" alt="question type" width="300px" />` : ''
        htmlStmt += '</div>'
        }
        htmlStmt += '<div class="act_head_group d-flex justify-content-center"  >';
            htmlStmt += '<div class="audioIcon off contant audioQuestionTitle" data-audio="' + aObj.audio + '">';
                htmlStmt += '<div class="activityHeading w-100">' + aObj.activityheading + '</div>';
            htmlStmt += '</div>';
        htmlStmt += '</div>';
            htmlStmt += '</div>';

		htmlStmt += '<div class="options cont_ht_sf mx-auto">';
		htmlStmt += '<div class="all_cont justify-content-start ml-90">';
        htmlStmt += '<div class="d-flex flex-wrap justify-content-start align-items-center">';
		...
		for(x= 0;x<numberofCols;x++){	
			htmlStmt += '<div class="question_group w-80 mt-50">';			
			for(y= 0;y<numOfQinCol;y++){
				...
				if(typeof tpOb != undefined && tpOb != null ){
					...
					htmlStmt += '<div class="ques_line d-flex">';
						...
						htmlStmt += '<div class="q_part gap-50 d-flex  align-items-baseline">';
					...
					htmlStmt += '</div>'; // - /q_part
					htmlStmt += '</div>';
					htmlStmt += '<div class="icon_wrap check p-2">';

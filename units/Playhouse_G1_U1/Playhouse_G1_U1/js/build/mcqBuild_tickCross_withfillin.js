  ...
  if (aObj != undefined && aObj != null) {
    ...
    for (x = 0; x < numOfQuestions; x++) {
      ...
      htmlStmt += '<div class="fillin_gr d-flex flex-wrap">';
      ...
      htmlStmt += '<div class="q_num_space">';
        ...
        htmlStmt += xx+'. </div>';
      htmlStmt += '<div class="checkBoxes">'; 
      htmlStmt += '<span class="pick_set d-flex" id="pick_set_'+(x+1)+'_1">';
      htmlStmt += '<span class="pick i_tick" id="pick_'+(x+1)+'_1_1" data-opttext=""><i class="fa fa-check" aria-hidden="true"></i></span>';
      htmlStmt += '<span class="pick i_cross" id="pick_'+(x+1)+'_1_2" data-opttext=""><i class="fa fa-times" aria-hidden="true"></i></span>';
      htmlStmt += '</span> ';   
      htmlStmt += '</div>';// - end checkBoxes
      ...
      htmlStmt += '</div>';
       if (tmpObj.image != '' && tmpObj.image != "no") {
        htmlStmt += '<div class="image_holder d-flex justify-content-center align-items-center"><div class="image_space"><img src="' + tmpObj.image + '"></div></div>';
      }

function buildMcqBody(aObj) {
  ...
  if (aObj != undefined && aObj != null) {
	...
	htmlStmt += '<div class="opction_grp d-flex justify-content-around flex-column">';
	htmlStmt += '<div class="btn_sets d-flex">';
		htmlStmt += '<div class="btn_sel_shape selectedShape" data-shape="circle">circle</div>';
		htmlStmt += '<div class="btn_sel_shape" data-shape="underline">underline</div>';
	htmlStmt += '</div>';// end - btn_sets
	htmlStmt += '<div class="all_elmt d-flex flex-wrap justify-content-center align-items-center">';
	htmlStmt += '<div class="qus_sets">';
...
htmlStmt += '<div class="justify-content-end icon_wrap_holder">';
	...
	htmlStmt += '</div>';// end - qus_sets
	if(aObj.image != 'no' && aObj.image != 'no'){
		htmlStmt += '<div class="image_holder">';
		htmlStmt += '<div class="image_space"><img src="'+aObj.image+'">';
		htmlStmt += '</div></div>';// 
	}
	htmlStmt += '</div>'// end - all_elmt
	htmlStmt += '</div>';// 

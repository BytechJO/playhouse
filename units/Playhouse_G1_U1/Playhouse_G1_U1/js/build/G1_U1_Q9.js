    ...
    function buildFillInBody(aObj) {		
		...
		if(aObj !=undefined && aObj !=null){
			...
			if(layOut == 1){
				...
				htmlStmt += '<div class="options cont_ht_sf mx-auto"><div class="all_cont justify-content-start ml-115"><div class="cont_group">';
				var rowCount = 1;
				for(x= 0;x<numOfRows;x++){
					htmlStmt += '<div class="row_'+rowCount+' d-flex flex-wrap justify-content-start flex-column">';
					for(y= 0;y<numInRowArray[x].length;y++){
						htmlStmt += '<div class="que d-flex align-items-center f_i_t_2_q_group f_i_t_2_g_'+(y+1)+'" data-qno="'+(currentQue)+'">';
						htmlStmt += '<span class="question">'+((aObj.questions)[currentQue-1]).question+'</span>';
						...
						htmlStmt += '<input class="mx-2 input-line border-dotted" type="text" maxlength="10">'

...
function buildHeader(aObj) {
    var fStmt = '';
    if (typeof aObj != undefined && aObj != null) {
        if (typeof aObj.bgimage != undefined && aObj.bgimage != null) {
        ...
        if (typeof (aObj.title).text != undefined && (aObj.title).text != null) {
            ...
            if (isMobile())
                ...
                fStmt += "<div class='unitTitleText'  data-placement='bottom' title='' data-original-title='" + (aObj.title).text + "'>" + (aObj.title).text + "</div>";
...
function buildFooter(aObj) {
    ...
    if (typeof aObj.buttons != undefined && aObj.buttons != null && typeof aObj.filetoload != undefined && aObj.filetoload != null) {
        ...
        fStmt += "</div><div class='homeBtn my-auto " + ((homeVisible == 'yes') ? 'd-block' : 'd-none') + "'>";
...
function buildSubFooter(aObj, aVal) {
    ...
    // var thisisActivity = thisFile.includes("activity");    
    ...
    if (thisisActivity && (thisFolder == 'views')) {
        if (typeof aObj != undefined && aObj != null) {
            ...
            fStmt += '</div>';
            //---------- nav_ctrls -------------------
            fStmt += '<div class="col-4 p-0 d-flex justify-content-center align-self-end">';
            fStmt += '<div class="d-flex nav_ctrls">';
            for (var nn = 0; nn < (aObj.navigationbuttons).length; nn++) {
                tsubBtn = ((aObj.navigationbuttons)[nn]).toLowerCase();
                fStmt += '<div class="sub_footer_icon subFooterNav ' + tsubBtn + 'Nav mx-1">';
                fStmt += '<a href=""><img src="' + _templatePath + _assetsPath + tsubBtn + '_btn.png"/></a>';
                fStmt += '</div>';
            }
            fStmt += '</div></div>';
            //---------- func_ctrls -------------------
            fStmt += '<div class="col-4 p-0 d-flex justify-content-end align-self-end">';
